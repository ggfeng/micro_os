...
#else
			ip4_addr = ip_2_ip4(&g_wlan_netif->ip_addr);
			wifi_status->ap_sta_status.sta_status.ipaddr = ip4_addr->addr;
#endif
...
#else
			ip4_addr = ip_2_ip4(&g_wlan_netif->ip_addr);
			wifi_status->ap_sta_status.ap_status.ipaddr = ip4_addr->addr;
#endif
