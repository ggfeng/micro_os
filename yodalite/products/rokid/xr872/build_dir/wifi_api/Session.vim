...
silent only
cd ~/yoda_lite/yodalite/products/rokid/xr871/src/wifi_api
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 wifi_smart_sniffer.c
argglobal
silent! argdel *
$argadd wifi_smart_sniffer.c
edit wifi_smart_sniffer.c
