...
struct rk_bluetooth
{
	...
	int (*create)(struct rk_bluetooth *bt);
...
extern int rk_bluetooth_device_init(struct rk_bluetooth *bt_dev);
extern struct bluetooth_module_t HAL_MODULE_INFO_SYM(BT_HAL_HW_ID);
__END_DECLS
