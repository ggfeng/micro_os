...
#define FF_MIN_SS     CONFIG_FATFS_SECTOR_SIZE
#define FF_MAX_SS     CONFIG_FATFS_SECTOR_SIZE 
...
/* If you need to know correct free space on the FAT32 volume, set bit 0 of this /  option, and f_getfree() function at first time after volume mount will force
